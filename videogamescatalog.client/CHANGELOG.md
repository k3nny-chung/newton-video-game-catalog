...
- Create Angular project with ng: `ng new videogamescatalog.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`videogamescatalog.client.esproj`).
